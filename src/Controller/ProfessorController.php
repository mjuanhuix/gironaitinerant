...
class ProfessorController extends AbstractController
{
    ...
    {
        return $this->render('professor/index.html.twig', ['professors' => $professorRepository->findAll()]);
    }
    ...
    /**
     * @Route("/{id}", name="professor_Mostrar", methods="GET")
     */
    public function show(Professor $professor): Response
    {
        return $this->render('professor/show.html.twig', ['professor' => $professor]);
    }
    ...
    public function edit(Request $request, Professor $professor): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('professor_edit', ['id' => $professor->getId()]);
        }
